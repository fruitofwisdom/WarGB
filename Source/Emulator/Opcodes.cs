		...
		private void HandleOpcode(byte instruction, out uint cycles)
		{
			...
			switch (instruction)
			{
				...
				case 0x75:      // LD (HL), L
					{
						byte l = (byte)(HL & 0x00FF);
						Memory.Instance.Write(HL, l);
						PrintOpcode(instruction, "LD (HL), L");
						PC++;
						cycles += 2;
					}
					break;
				...
				case 0x88:      // ADC A, B
					{
						byte bAndCY = B;
						Add(ref bAndCY, (byte)(CY ? 0x01 : 0x00));
						bool firstH = H;
						bool firstCY = CY;
						Add(ref A, bAndCY);
						H |= firstH;
				...
				case 0x89:      // ADC A, C
					{
						byte cAndCY = C;
						Add(ref cAndCY, (byte)(CY ? 0x01 : 0x00));
						bool firstH = H;
						bool firstCY = CY;
						Add(ref A, cAndCY);
						H |= firstH;
				...
				case 0x8A:      // ADC A, D
					{
						byte dAndCY = D;
						Add(ref dAndCY, (byte)(CY ? 0x01 : 0x00));
						bool firstH = H;
						bool firstCY = CY;
						Add(ref A, dAndCY);
						H |= firstH;
				...
				case 0x8B:      // ADC A, E
					{
						byte eAndCY = E;
						Add(ref eAndCY, (byte)(CY ? 0x01 : 0x00));
						bool firstH = H;
						bool firstCY = CY;
						Add(ref A, eAndCY);
						H |= firstH;
				...
				case 0x8C:      // ADC A, H
					{
						byte h = (byte)((HL & 0xFF00) >> 8);
						byte hAndCY = h;
						Add(ref hAndCY, (byte)(CY ? 0x01 : 0x00));
						bool firstH = H;
						bool firstCY = CY;
						Add(ref A, hAndCY);
						H |= firstH;
				...
				case 0x8D:      // ADC A, L
					{
						byte l = (byte)(HL & 0x00FF);
						byte lAndCY = l;
						Add(ref lAndCY, (byte)(CY ? 0x01 : 0x00));
						bool firstH = H;
						bool firstCY = CY;
						Add(ref A, lAndCY);
						H |= firstH;
				...
				case 0x8F:      // ADC A, A
					{
						byte aAndCY = A;
						Add(ref aAndCY, (byte)(CY ? 0x01 : 0x00));
						bool firstH = H;
						bool firstCY = CY;
						Add(ref A, aAndCY);
						H |= firstH;
				...
				case 0x9F:      // SBC A, A
					{
						...
						H |= firstH;
						CY |= firstCY;
						PrintOpcode(instruction, "SBC A, A");
						PC++;
						cycles++;
					}
					break;
				...
				case 0xF6:      // OR d8
					{
						...
						H = false;
						CY = false;
						PrintOpcode(instruction, $"OR 0x{d8:X2}");
						PC += 2;
						cycles += 2;
					}
					break;
		...
		private void Handle16BitOpcode(byte instruction, out uint cycles)
		{
			...
			switch (instruction)
			{
				...
				case 0x26:      // SLA (HL)
					{
						...
						N = false;
						H = false;
						PrintOpcode(instruction, "SLA (HL)");
						PC += 2;
						cycles += 4;
					}
					break;
				...
				case 0x2E:      // SRA (HL)
					{
						...
						N = false;
						H = false;
						PrintOpcode(instruction, "SRA (HL)");
						PC += 2;
						cycles += 4;
					}
					break;
				...
				case 0x34:      // SWAP H
					{
						byte h = (byte)((HL & 0xFF00) >> 8);
						byte l = (byte)(HL & 0x00FF);
						byte lower = (byte)(h & 0x0F);
						byte higher = (byte)(h & 0xF0);
						h = (byte)((higher >> 4) + (lower << 4));
						HL = (ushort)((h << 8) + l);
						Z = h == 0x00;
						N = false;
						H = false;
						CY = false;
						PrintOpcode(instruction, "SWAP H");
						PC += 2;
						cycles += 2;
					}
					break;
				...
				case 0x35:      // SWAP L
					{
						byte h = (byte)((HL & 0xFF00) >> 8);
						byte l = (byte)(HL & 0x00FF);
						byte lower = (byte)(l & 0x0F);
						byte higher = (byte)(l & 0xF0);
						l = (byte)((higher >> 4) + (lower << 4));
						HL = (ushort)((h << 8) + l);
						Z = l == 0x00;
						N = false;
						H = false;
						CY = false;
						PrintOpcode(instruction, "SWAP L");
						PC += 2;
						cycles += 2;
					}
					break;
				...
				case 0x44:      // BIT 0, H
					{
						byte h = (byte)((HL & 0xFF00) >> 8);
						byte bit = Utilities.GetBitsFromByte(h, 0, 0);
						Z = bit == 0x00;
						N = false;
						H = true;
						PrintOpcode(instruction, "BIT 0, H");
						PC += 2;
						cycles += 2;
					}
					break;
				...
				case 0x4C:      // BIT 1, H
					{
						byte h = (byte)((HL & 0xFF00) >> 8);
						byte bit = Utilities.GetBitsFromByte(h, 1, 1);
						Z = bit == 0x00;
						N = false;
						H = true;
						PrintOpcode(instruction, "BIT 1, H");
						PC += 2;
						cycles += 2;
					}
					break;
				...
				case 0x54:      // BIT 2, H
					{
						byte h = (byte)((HL & 0xFF00) >> 8);
						byte bit = Utilities.GetBitsFromByte(h, 2, 2);
						Z = bit == 0x00;
						N = false;
						H = true;
						PrintOpcode(instruction, "BIT 2, H");
						PC += 2;
						cycles += 2;
					}
					break;
				...
				case 0x60:      // BIT 4, B
					{
						byte bit = Utilities.GetBitsFromByte(B, 4, 4);
						Z = bit == 0x00;
						N = false;
						H = true;
						PrintOpcode(instruction, "BIT 4, B");
						PC += 2;
						cycles += 2;
					}
					break;
				...
				case 0x68:      // BIT 5, B
					{
						byte bit = Utilities.GetBitsFromByte(B, 5, 5);
						Z = bit == 0x00;
						N = false;
						H = true;
						PrintOpcode(instruction, "BIT 5, B");
						PC += 2;
						cycles += 2;
					}
					break;
				...
				case 0x6E:      // BIT 5, (HL)
					{
						byte d8 = Memory.Instance.Read(HL);
						byte bit = Utilities.GetBitsFromByte(d8, 5, 5);
						Z = bit == 0x00;
						N = false;
						H = true;
						PrintOpcode(instruction, "BIT 5, (HL)");
						PC += 2;
						cycles += 3;
					}
					break;
				...
				case 0x71:      // BIT 6, C
					{
						byte bit = Utilities.GetBitsFromByte(C, 6, 6);
						Z = bit == 0x00;
						N = false;
						H = true;
						PrintOpcode(instruction, "BIT 6, C");
						PC += 2;
						cycles += 2;
					}
					break;
				...
				case 0x81:      // RES 0, C
					{
						Utilities.SetBitsInByte(ref C, 0x00, 0, 0);
						PrintOpcode(instruction, "RES 0, C");
						PC += 2;
						cycles += 2;
					}
					break;
				...
				case 0x83:      // RES 0, E
					{
						Utilities.SetBitsInByte(ref E, 0x00, 0, 0);
						PrintOpcode(instruction, "RES 0, E");
						PC += 2;
						cycles += 2;
					}
					break;
				...
				case 0xA6:      // RES 4, (HL)
					{
						byte d8 = Memory.Instance.Read(HL);
						Utilities.SetBitsInByte(ref d8, 0x00, 4, 4);
						Memory.Instance.Write(HL, d8);
						PrintOpcode(instruction, "RES 4, (HL)");
						PC += 2;
						cycles += 4;
					}
					break;
				...
				case 0xB5:      // RES 6, L
					{
						byte h = (byte)((HL & 0xFF00) >> 8);
						byte l = (byte)(HL & 0x00FF);
						Utilities.SetBitsInByte(ref l, 0x00, 6, 6);
						HL = (ushort)((h << 8) + l);
						PrintOpcode(instruction, "RES 6, L");
						PC += 2;
						cycles += 2;
					}
					break;
				...
				case 0xB8:      // RES 7, B
					{
						Utilities.SetBitsInByte(ref B, 0x00, 7, 7);
						PrintOpcode(instruction, "RES 7, B");
						PC += 2;
						cycles += 2;
					}
					break;
				...
				case 0xBD:      // RES 7, L
					{
						byte h = (byte)((HL & 0xFF00) >> 8);
						byte l = (byte)(HL & 0x00FF);
						Utilities.SetBitsInByte(ref l, 0x00, 7, 7);
						HL = (ushort)((h << 8) + l);
						PrintOpcode(instruction, "RES 7, L");
						PC += 2;
						cycles += 2;
					}
					break;
				...
				case 0xC1:      // SET 0, C
					{
						Utilities.SetBitsInByte(ref C, 0x01, 0, 0);
						PrintOpcode(instruction, "SET 0, C");
						PC += 2;
						cycles += 2;
					}
					break;
				...
				case 0xC3:      // SET 0, E
					{
						Utilities.SetBitsInByte(ref E, 0x01, 0, 0);
						PrintOpcode(instruction, "SET 0, E");
						PC += 2;
						cycles += 2;
					}
					break;
				...
				case 0xC9:      // SET 1, C
					{
						Utilities.SetBitsInByte(ref C, 0x01, 1, 1);
						PrintOpcode(instruction, "SET 1, C");
						PC += 2;
						cycles += 2;
					}
					break;
				...
				case 0xCA:      // SET 1, D
					{
						Utilities.SetBitsInByte(ref D, 0x01, 1, 1);
						PrintOpcode(instruction, "SET 1, D");
						PC += 2;
						cycles += 2;
					}
					break;
				...
				case 0xCB:      // SET 1, E
					{
						Utilities.SetBitsInByte(ref E, 0x01, 1, 1);
						PrintOpcode(instruction, "SET 1, E");
						PC += 2;
						cycles += 2;
					}
					break;
				...
				case 0xCD:      // SET 1, L
					{
						byte h = (byte)((HL & 0xFF00) >> 8);
						byte l = (byte)(HL & 0x00FF);
						Utilities.SetBitsInByte(ref l, 0x01, 1, 1);
						HL = (ushort)((h << 8) + l);
						PrintOpcode(instruction, "SET 1, L");
						PC += 2;
						cycles += 2;
					}
					break;
				...
				case 0xD1:      // SET 2, C
					{
						Utilities.SetBitsInByte(ref C, 0x01, 2, 2);
						PrintOpcode(instruction, "SET 2, C");
						PC += 2;
						cycles += 2;
					}
					break;
				...
				case 0xD9:      // SET 3, C
					{
						Utilities.SetBitsInByte(ref C, 0x01, 3, 3);
						PrintOpcode(instruction, "SET 3, C");
						PC += 2;
						cycles += 2;
					}
					break;
				...
				case 0xDA:      // SET 3, D
					{
						Utilities.SetBitsInByte(ref D, 0x01, 3, 3);
						PrintOpcode(instruction, "SET 3, D");
						PC += 2;
						cycles += 2;
					}
					break;
				...
				case 0xF0:      // SET 6, B
					{
						Utilities.SetBitsInByte(ref B, 0x01, 6, 6);
						PrintOpcode(instruction, "SET 6, B");
						PC += 2;
						cycles += 2;
					}
					break;
				...
				case 0xF8:      // SET 7, B
					{
						Utilities.SetBitsInByte(ref B, 0x01, 7, 7);
						PrintOpcode(instruction, "SET 7, B");
						PC += 2;
						cycles += 2;
					}
					break;
				...
				case 0xFA:      // SET 7, D
					{
						Utilities.SetBitsInByte(ref D, 0x01, 7, 7);
						PrintOpcode(instruction, "SET 7, D");
						PC += 2;
						cycles += 2;
					}
					break;
				...
				case 0xFD:      // SET 7, L
					{
						byte h = (byte)((HL & 0xFF00) >> 8);
						byte l = (byte)(HL & 0x00FF);
						Utilities.SetBitsInByte(ref l, 0x01, 7, 7);
						HL = (ushort)((h << 8) + l);
						PrintOpcode(instruction, "SET 7, L");
						PC += 2;
						cycles += 2;
					}
					break;

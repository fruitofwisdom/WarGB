namespace WarGB
{
	partial class AboutBox
	{
		...
		private void InitializeComponent()
		{
			...
			labelVersion.Text = "Version 0.4-beta";
			labelVersion.TextAlign = ContentAlignment.MiddleLeft;
			// 
			// labelAuthor
			// 
			labelAuthor.Dock = DockStyle.Fill;
			labelAuthor.Location = new Point(167, 60);
			...
			labelAuthor.Text = "Ward Childress";
			...
			textBoxDescription.Text = "Welcome to version 0.4-beta of WarGB, a Game Boy emulator written in C#.";
			// 
			// okButton
			// 
